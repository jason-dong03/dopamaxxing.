...
export function CardStatsPanel({
    ...
    const buyback = calculateBuyback(
        currentCard.rarity,
        currentCard.worth,
        ...
        <>
                    ...
                    >
                        ...
                        >
                            <div>
                                ...
                                >
                                    $
                                    {currentCard.worth != null
                                        ? Number(currentCard.worth).toFixed(2)
                                        : '—'}
                                </span>
                            </div>
                            <div>
            ...
            {statsTooltipPos &&
                createPortal(
                    <div
                        style={{
                            position: 'fixed',
                            top: statsTooltipPos.y,
                            left: statsTooltipPos.x,
                            width: 210,
                            background: 'rgba(15,15,20,0.97)',
                            border: '1px solid rgba(255,255,255,0.1)',
                            borderRadius: 8,
                        ...
                        >
                            ...
                            <div>
                                ...
                                <span style={{ color: '#fbbf24' }}>
                                    ×
                                    {(
                                        RARITY_MULTIPLIER[currentCard.rarity] ??
                                        1
                                    ).toFixed(2)}{' '}
                                    ({currentCard.rarity})
                                </span>
                            ...
                            >
                                Cards without Pokédex data use flat rarity-based
                                ranges instead.
                            </div>
                        </div>
                    </div>,
            ...
            >
                ...
                >
                    ...
                    {condPanelTab === 'stats' &&
                        (() => {
                            const nat = currentCard.preview_nature
                                ? NATURE_BY_NAME[currentCard.preview_nature]
                                : null
                            const natColor = nat
                                ? NATURE_TIER_COLOR[nat.tier]
                                : '#94a3b8'
                                            ...
                                            >
                                                ...
                                                <span
                                                    style={{
                                                        ...
                                                        fontWeight: 800,
                                                        color: natColor,
                                                        textShadow: `0 0 6px ${natColor}66`,
                                                    }}
                                                >
                                                    {nat.name}
                                                </span>
                                                {nat.tier !== 'regular' && (
                                                    <span
                                                        style={{
                                                            ...
                                                            padding: '1px 5px',
                                                            borderRadius: 4,
                                                            background: `${natColor}18`,
                                                            border: `1px solid ${natColor}55`,
                                                            color: natColor,
                                                            letterSpacing:
                                                                '0.06em',
                                                            textTransform:
                                                ...
                                                >
                                                    ...
                                                    >
                                                        <div
                                                            style={{
                                                                height: '100%',
                                                                width: `${(v / Math.max(maxSt, 160)) * 100}%`,
                                                                background: c,
                                                                borderRadius: 2,
                                                            }}
                                                        />
                    ...
                    {condPanelTab === 'condition' && (
                        <>
                            {hasAttrs && overall != null && overall <= 1 && (
                                ...
                                >
                                    {['psa1-q1', 'psa1-q2', 'psa1-q3'].map(
                                        (key, i) => (
                                            <span
                                                key={key}
                                                className={`psa1-question psa1-q${i + 1}`}
                                                style={{
                                                    position: 'absolute',
                                                    fontSize:
                                                        i === 1
                                    ...
                                    >
                                        {attrs.map(({ label, value }) => (
                                            ...
                                            >
                                                ...
                                                <div
                                                    className="pack-cond-bar-track flex-1 rounded-full overflow-hidden"
                                                    style={{
                                                        height: isMobile
                                                            ? 6
                                                            : 5,
                            ...
                            <div
                                ...
                                style={{
                                    marginTop: hasAttrs ? 7 : 0,
                                    paddingTop: hasAttrs ? 7 : 0,
                                    borderTop: hasAttrs
                ...
                >
                    ...
                    <div style={{ position: 'relative' }}>
                        ...
                        {!isMobile && hoveredBtn === 'sell' && (
                            ...
                            >
                                Sell (${fmt(Number(buyback.amount))})
                            </div>
                        )}
                    </div>
                </div>
